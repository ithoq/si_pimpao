        ...
        <div class="span12">
          <div class="grid simple ">
            <div class="grid-title">
              <h3> Vendedora editada!<span class="semi-bold"></span> </h3>
              <div class="tools"></div>
            </div>
            <div class="grid-body ">
                <!-- BEGIN CONTENT -->
                <?php
                    ...
                    $db = mysqli_connect($servidor,$username,$password,$database);
                    if (mysqli_connect_errno()) { echo "Erro de conexão!"; exit;}
                    $query = "UPDATE vendedora SET nome='".$nome."', telefone='".$telefone."', email='".$email."' WHERE id='".$_GET['id']."' ";
            ...
            <div class="grid-body no-border">
              <div class="row-fluid">
                ...
                <a href="cadastrar_vendedoras.php">
                    <button type="button" class="btn btn-primary btn-cons" style='background-color: #fcc400'>Cadastrar Vendedora</button>
                </a>
                <a href="listar_vendedoras.php" >
                    <button type="button" class="btn btn-primary btn-cons" style='background-color: #fcc400'>Listar Vendedoras</button>
                </a>
                <!-- END CONTENT -->
            </div>
          </div>
