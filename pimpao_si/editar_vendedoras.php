        ...
        <div class="span12">
          <div class="grid simple ">
            <div class="grid-title">
              <h3> Editar Vendedoras<span class="semi-bold"></span> </h3>
              <div class="tools"></div>
            </div>
            <div class="grid-body ">
                <?php
                ...
                $seleciona = "SELECT * FROM vendedora where id='".$_GET['id']."'";
                $query=mysqli_query($db,$seleciona);
                $row = mysqli_fetch_array($query);
                ?>

                <form name="form_vendedoras" action="sucesso_editar_vendedoras.php?id=<?php echo $row[0]; ?>" method="post">
                    Nome: <br><input type="text" name="nome" value="<?php echo $row['nome']; ?>"><br><br>
                    Telefone: <br><input type="number" name="telefone" value="<?php echo $row['telefone']; ?>"><br><br>
