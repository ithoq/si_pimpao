        ...
        <div class="span12">
          <div class="grid simple ">
            <div class="grid-title">
              <h3> Venda editada!<span class="semi-bold"></span> </h3>
              <div class="tools"></div>
            </div>
            <div class="grid-body ">
                <!-- BEGIN CONTENT -->
                <?php
                    ...
                    $db = mysqli_connect($servidor,$username,$password,$database);
                    if (mysqli_connect_errno()) { echo "Erro de conexão!"; exit;}
                    $query = "UPDATE venda SET valor='".$valor."', vendedora='".$vendedora."', data='".$data."', tipo='".$tipo."', numero='".$numero."' WHERE id='".$_GET['id']."' ";
