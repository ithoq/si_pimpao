        ...
        <div class="span12">
          <div class="grid simple ">
            <div class="grid-title">
              <h3> Editar Produtos<span class="semi-bold"></span> </h3>
              <div class="tools"></div>
            </div>
            <div class="grid-body ">
                <?php
                ...
                $seleciona = "SELECT * FROM produto where id='".$_GET['id']."'";
                $query=mysqli_query($db,$seleciona);
                $row = mysqli_fetch_array($query);
                ?>

                <form name="form_produtos" action="sucesso_editar_produtos.php?id=<?php echo $row[0]; ?>" method="post">
                    Nome: <br><input type="text" name="nome" value="<?php echo $row['nome']; ?>"><br><br>
                    Código: <br><input type="number" name="codigo" value="<?php echo $row['codigo']; ?>"><br><br>
                    Preço: <br><input type="number" name="preco" value="<?php echo $row['preco']; ?>"><br><br>
